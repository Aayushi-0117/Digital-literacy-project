...
# Task Summaries
- Task 1 – Infographic: Created a one-page Canva design explaining digital literacy, safe internet practices, and email etiquette.
- Task 2 – Portfolio: Set up accounts on GitHub, LinkedIn, and Kaggle to build a professional digital presence.
- Task 3 – Platforms: Practiced coding on HackerRank (Solve Me First) and created a Google Form quiz for batchmates.
- Task 4 – Email Etiquette: Drafted two professional emails and designed a Social Media Do’s and Don’ts checklist.
- Task 5 – Cybercrime Awareness: Researched phishing attacks, wrote a case study, and created a prevention checklist with reporting channels.

 # Useful Links
 https://docs.google.com/forms/d/e/1FAIpQLScew5oh7_xnj4wWMyu5-oqtFpd_qqggrTAIC3wlpKXz4VfWWw/viewform?usp=publish-editor
